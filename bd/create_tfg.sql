...
insert into libro (titulo,portada,sinopsis,autor,paginas) values ("El Imperio final (Nacidos de la Bruma)","1.jpg",
...
una joven ladrona callejera que deberá aprender a controlar el poder de los nacidos de la bruma.","Brandon Sanderson","541");
insert into libro (titulo,portada,sinopsis,autor,paginas) values ("El Pozo de la Ascensión (Nacidos de la Bruma)", "2.jpg","
...
religiosa debe lidiar con los siempre misteriosos poderes de la alomancia...","Brandon Sanderson","784");
insert into libro (titulo,portada,sinopsis,autor,paginas) values ("El Héroe de las Eras (Nacidos de la Bruma)", "3.jpg","El Héroe de las Eras es el tercer volumen de la saga 
...
Una de ellas nos redimirá. Y una de ellas nos destruirá.","Brandon Sanderson",1200);
select * from libro;
...
select * FROM publicacion p JOIN seguidores s ON p.id_usuario = s.id_seguido WHERE s.id_seguidor = 1;
