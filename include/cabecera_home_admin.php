...
<head>
    ...
    <link rel="stylesheet" href="<?= $HojaCSS ?>">
    ...
    <nav class="navbar navbar-expand-lg navbar-collapse-md" style="background-color: rgb(252, 241, 227)">
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="menu1">
                <ul class="navbar-nav">
                    <li class="nav-item">
                        <a class="nav-link <?= $activoHome ?>" href="../paginas_principales/home.php" title="Home">
                    ...
                    <li class="nav-item">
                        <a class="nav-link <?= $activoSeguidos ?>" href="../paginas_principales/seguidos.php" title="Seguidos">
                    ...
                    <li class="nav-item">
                        <a class="nav-link <?= $activoBiblioteca ?>" href="../paginas_principales/biblioteca.php" title="Biblioteca">
                    ...
                    <li class="nav-item">
                        <a class="nav-link <?= $activoBuscador ?>" href="../paginas_principales/buscador.php" title="Buscador">
                            <svg xmlns="http://www.w3.org/2000/svg" width="10" height="10" fill="currentColor" class="bi bi-bookshelf" viewBox="0 0 20 20">
                    ...
                    <li class="nav-item">
                        <a class="nav-link <?= $activoEspacioLectura ?>" target="_blank" href="https://web.koodoreader.com/#/manager/home" title="Espacio de lectura">
                            <svg xmlns="http://www.w3.org/2000/svg" width="10" height="10" fill="currentColor" class="bi bi-bookshelf" viewBox="0 0 20 20">
                    ...
                    <li class="nav-item">
                        <a class="nav-link <?= $activoAdmin ?>" href="../paginas_principales/administracion.php" title="Administración">
                ...
                <ul class="navbar-nav ms-auto">
                    <li class="nav-item">
                        <a class="nav-link <?= $activoPerfil?>" href="../paginas_principales/perfil.php?usuario=<?php echo $usuario->usuario?>" title="Mi perfil">
                            <img id="imagen_perfil_nav" src="<?= Usuario::getRutaFotoObjeto($usuario) ?>" width="45" height="45">
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="../gestion_cuentas/logout.php" title="Cerrar sesión">
                            <svg xmlns="http://www.w3.org/2000/svg" width="10" height="10" fill="currentColor" class="bi bi-box-arrow-right" viewBox="0 0 20 20">
